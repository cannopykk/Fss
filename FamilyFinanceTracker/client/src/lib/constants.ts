...
// Smart contract ABI - Complete ABI for FamilySmartSaver contract
    ...
    "outputs": [
      {
        ...
        "internalType": "struct FamilySmartSaver.Contribution[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
...
// Contract address deployed on Web5Layer via Remix IDE
export const DEFAULT_CONTRACT_ADDRESS = "0x97C2A6E859F047FA36d7bA372e226917508c23b0";

// Network configuration
export const NETWORKS = {
  web5layer: {
    chainId: 9000, // Web5Layer actual chain ID
    name: "Web5Layer",
